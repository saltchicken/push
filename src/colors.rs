...
pub const DARK_GREY: u8 = 1;
pub const LIGHT_GREY: u8 = 2;
pub const WHITE: u8 = 3;

pub const RED_LED_LOW: u8 = 4;
pub const RED_LED: u8 = 5;
pub const RED_LED_BRIGHT: u8 = 6;
pub const RED_AMBER_LOW: u8 = 7;

pub const RED_AMBER: u8 = 8;
pub const RED_AMBER_BRIGHT: u8 = 9;
pub const AMBER_RED_LOW: u8 = 10;
pub const AMBER_RED: u8 = 11;

pub const AMBER_RED_BRIGHT: u8 = 12;
pub const AMBER_LOW: u8 = 13;
pub const AMBER: u8 = 14;
pub const AMBER_BRIGHT: u8 = 15;

pub const AMBER_YELLOW_LOW: u8 = 16;
pub const AMBER_YELLOW: u8 = 17;
pub const AMBER_YELLOW_BRIGHT: u8 = 18;
pub const YELLOW_AMBER_LOW: u8 = 19;

pub const YELLOW_AMBER: u8 = 20;
